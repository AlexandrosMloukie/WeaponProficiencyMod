...
public class EnhancedBow extends BowItem {
    public static boolean isUsing = false;
    public static int duration;

    public EnhancedBow(Properties p_40660_) {
        super(p_40660_);
    }
    ...
    public void releaseUsing(ItemStack p_40667_, Level p_40668_, LivingEntity p_40669_, int p_40670_) {
        ...
        if (p_40669_ instanceof Player player) {
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                float f = getCustomPowerFromTime(i);
                if (!((double)f < 0.2D)) {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        isUsing = true;
        duration = this.getUseDuration(new ItemStack(this));
        return super.use(pLevel, pPlayer, pHand);
    }

    public static boolean getUsing() { return isUsing; }
    public static int getDuration() { return duration; }

    public static float getCustomPowerFromTime(int i)
    {
