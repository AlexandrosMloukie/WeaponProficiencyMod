...
import net.amloukie.wpmod.thirst.PlayerThirst;
...
@Mod.EventBusSubscriber(modid = WeaponProficiencyMod.MOD_ID)
public class ModEvents {
    ...
    public static void onAttachCapabilitiesPlayer(AttachCapabilitiesEvent<Entity> event)
    {
        if(event.getObject() instanceof Player)
        {
            ...
            {
                event.addCapability(new ResourceLocation(WeaponProficiencyMod.MOD_ID, "properties"), new PlayerThirstProvider());
            }
        }
    }
